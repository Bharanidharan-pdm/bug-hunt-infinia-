...
async function guardAdmin() {
  ...
  catch (e) { if (/401|403|logged/i.test(e.message)) { document.body.innerHTML = '<div class="wrap" style="padding:80px 20px;text-align:center"><h1>403 – Access Denied</h1><p class="mut">Admins only. <a href="login.html">Admin login</a></p></div>'; return null; } throw e; }
}
function logout(team = true) { localStorage.removeItem(team ? 'bh_team_token' : 'bh_admin_token'); location.href = team ? 'index.html' : 'login.html'; }
